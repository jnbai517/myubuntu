...
# Modified: Ubuntu 24.04 LTS base + FreeSurfer license + OpenClaw support
#
# Example build:
...
# Updated: Package names and dependencies for Ubuntu 24.04
...
# Install dependencies for FreeSurfer and neuroimaging tools (Ubuntu 24.04)
...
RUN pip3 install --break-system-packages numpy nibabel scipy pandas 

# Compile and configure ANTs (Ubuntu 24.04)
...
# Compile and configure AFNI (Ubuntu 24.04)
...
# Compile and configure mrtrix3 (Ubuntu 24.04 with Qt6)
...
# ============================================================
# OpenClaw Installation (Ubuntu 24.04.3 LTS compatible)
# ============================================================
# Install Node.js 22.x (same as host system)
...
# Install OpenClaw globally (same version as host: 2026.3.8)
...
# Install useful OpenClaw skills (matching host system)
